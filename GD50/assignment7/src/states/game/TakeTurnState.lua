            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        -- get stat increases from levelUp
                        local hI, aI, dI, sI = self.playerPokemon:levelUp()
                        local levelUp = true
                        ...
                        -- push menu state infront of message so that fadeout still occurs and menu is in front
                        -- also menu gets all stat increase variables to display levelUp
                        gStateStack:push(BattleMenuState(self.battleState, levelUp, hI, aI, dI, sI))
