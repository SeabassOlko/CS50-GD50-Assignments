...
function Dungeon:init(player)
    ...
    -- event for pots being picked up, carried and thrown
    Event.on('lift-pot', function()
        for k, object in pairs(self.currentRoom.objects) do
            if self.player:collides(object) and object.solid and player.pot == false then
                object.pickedUp = true
                object.foreground = true
    ...
    Event.on('throw-pot', function()
        for k, object in pairs(self.currentRoom.objects) do
            if object.pickedUp then
                ...
                object.onCollide = function(entity)
