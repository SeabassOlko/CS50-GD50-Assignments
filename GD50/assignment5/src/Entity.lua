...
function Entity:init(def)
    ...
    -- holder for if entity has heart
...
-- function for healing player or enemies
function Entity:heal(health)
    if self.health + health > MAX_HEALTH then
        self.health = 6
    else
