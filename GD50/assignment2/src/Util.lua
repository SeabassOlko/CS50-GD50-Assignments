...
--[[
    This function is made to piece out the lock from the sprite sheet since its 
    in an akward position in the sheet
]]
...
--[[
    This funtion is made to piece out both powerups of the more balls powerup and
    the key powerup since they are in akward positions on the sheet 
]]
